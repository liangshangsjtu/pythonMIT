## from week 2 EXERCISE: GUESS MY NUMBER
"""
...
## BELOW IS MY RAW CODE. BUT IT IS NOT RIGHT, ? THE MAIN PROBLEM LIES IN THE USE OF "BREAK" 
low=0
high=100
guess=(low+high)/2
...
while True:
    ...
    secret=raw_input("Enter 'h' to indicate the guess is too high. Enter 'l' to indicate the guess is too low. Enter 'c' to indicate I guessed correctly.")
    if secret == "c":
